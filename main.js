...
var game = {
  ...
  gameOver: function() {
    ...
    $('.report').html("<p>Your score: " + ((perfect/this.moves)*100) +"%" + "</p><p>Expected Moves: " + perfect + "</p");
  },
  reset: function() {
  ...
  displayLevelSelector: function() {
    ...
    $levelButton.hide();
    this.over = true;
    var $levelSelect = $("<div class='level-select'><p>Select Discs</p><div class='level-select-box'><p class='arrow left'><</p><span class='level'>4</span><p class='arrow right'>></p></div></div>");
    $columns.children().remove();
